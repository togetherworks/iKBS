...
<img src="/ikbs/image/rrHeader.gif"><br>
	...
	<tr>
		...
		<td class="formName"><input type="text" name="nodeName" value="<%= request.getParameter("nodeName") %>"></td>
	...
	<tr>
		...
		<td class="formName"><input type="text" name="appName" value="<%= request.getParameter("appName") %>"></td>
