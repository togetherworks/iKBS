...
function showNoteForProSearch() {
	...
	<BODY>
		...
		<%
		            ...
		            else if (appSearch != null && appSearch.equals("Skilled Group Contact"))
		            {
		            ...
		            else if (appSearch != null && appSearch.equals("Skilled Group"))
		            {
		...
		<FORM name=thisForm method="POST"
			action="/ikbs/kbs/applicationSearch.do">
			...
			<SELECT name="appSearch" onchange="showNoteForProSearch()">
				...
				<OPTION value="Skilled Group Contact" <%=conSel%>>
					Skilled Group Contact
				</OPTION>

				<OPTION value="Skilled Group" <%=grpSel%>>
					Skilled Group
				</OPTION>
