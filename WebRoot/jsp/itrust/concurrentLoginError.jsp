...
<title><fmt:message key="concurrentLoginError.jsp.title"/></title>
    ...
    <td> <br>
      ...
      <tr>
        ...
        <td background="<session:constant name="ContextPath"/>/images/headbg.jpg" class="header" height="2" width="591">
			<fmt:message key="concurrentLoginError.jsp.title"/>
        </td>
        <td width="30" height="2"><img src="<session:constant name="ContextPath"/>/images/head2.jpg" height="40"></td>
      </tr>
      </table>      
      <table>
		<tr><td><div class="bodytxt"><fmt:message key="concurrentLoginError.jsp.DescPart1"/></div></td></tr>
		<tr><td><div class="bodytxt"><fmt:message key="concurrentLoginError.jsp.DescPart2"/></div></td></tr>
		<tr><td><div class="bodytxt"><fmt:message key="concurrentLoginError.jsp.DescPart3"/><div></td></tr>
		<tr><td><div class="bodytxt"><fmt:message key="concurrentLoginError.jsp.DescPart4"/></div></td></tr>
		</table>
    </td>
  </tr>
</table>
...
<form method="POST" action="loginForm.jsp" name="form">
	<div class="bodytxt"><fmt:message key="concurrentLoginError.jsp.Bypass.Desc"/>
