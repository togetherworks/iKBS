...
<table width="98%" align="center" cellpadding="0" cellspacing="0" border="0">
  <tr>
	...
	<form method="post" action="userchangepassword2.jsp" name="form" onsubmit="return dode();">
	...
	<input type=hidden name="loginName" value="<session:info name="LoginId"/>" >
	</form>
	</body>
</html>